...
export default function FeaturedProjects() {
  ...
  return (
    <section id="projects" className="relative py-20 px-4 sm:px-6 lg:px-8 scroll-snap-section">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            <div className="w-4/5 h-3/4 bg-gradient-radial from-[rgba(72,155,172,0.25)] via-[rgba(72,155,172,0.12)] to-transparent rounded-full blur-xl"></div>
          </div>
